...
import modmacao.provider.InstallationdependencyItemProvider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.tosca.Tosca_relationships_root} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Tosca_relationships_rootItemProvider extends InstallationdependencyItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ToscaPackage.Literals.TOSCA_RELATIONSHIPS_ROOT__TOSCA_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ToscaPackage.Literals.TOSCA_RELATIONSHIPS_ROOT__STATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ToscaPackage.Literals.TOSCA_RELATIONSHIPS_ROOT__TOSCA_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
