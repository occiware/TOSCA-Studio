...
/**
 * This is the item provider adapter for a {@link extendedtosca.Tosca_nodes_webapplication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Tosca_nodes_webapplicationItemProvider extends Tosca_nodes_rootItemProvider {
	/**
	 ...
	 * @generated
	 */
	public Tosca_nodes_webapplicationItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addContextRootPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tosca_nodes_webapplication_contextRoot_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tosca_nodes_webapplication_contextRoot_feature", "_UI_Tosca_nodes_webapplication_type"),
				 ExtendedtoscaPackage.Literals.TOSCA_NODES_WEBAPPLICATION__CONTEXT_ROOT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns Tosca_nodes_webapplication.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Tosca_nodes_webapplication"));
	}
	...
	public String getText(Object object) {
		String label = ((Tosca_nodes_webapplication)object).getPortName();
		return label == null || label.length() == 0 ?
			getString("_UI_Tosca_nodes_webapplication_type") :
			getString("_UI_Tosca_nodes_webapplication_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Tosca_nodes_webapplication.class)) {
