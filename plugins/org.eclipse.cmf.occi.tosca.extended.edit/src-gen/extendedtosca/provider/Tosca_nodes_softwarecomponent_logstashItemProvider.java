...
import org.eclipse.cmf.occi.tosca.provider.Tosca_nodes_softwarecomponentItemProvider;
...
/**
 * This is the item provider adapter for a {@link extendedtosca.Tosca_nodes_softwarecomponent_logstash} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Tosca_nodes_softwarecomponent_logstashItemProvider extends Tosca_nodes_softwarecomponentItemProvider {
	/**
	 ...
	 * @generated
	 */
	public Tosca_nodes_softwarecomponent_logstashItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns Tosca_nodes_softwarecomponent_logstash.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Tosca_nodes_softwarecomponent_logstash"));
	}
	...
	public String getText(Object object) {
		String label = ((Tosca_nodes_softwarecomponent_logstash)object).getPortName();
		return label == null || label.length() == 0 ?
			getString("_UI_Tosca_nodes_softwarecomponent_logstash_type") :
			getString("_UI_Tosca_nodes_softwarecomponent_logstash_type") + " " + label;
	}
