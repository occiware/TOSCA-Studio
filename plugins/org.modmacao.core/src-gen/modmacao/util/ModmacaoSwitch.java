	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModmacaoPackage.APPLICATION: {
				...
				if (result == null) result = caseMixinBase(application);
			...
			case ModmacaoPackage.DEPENDENCY: {
				...
				if (result == null) result = caseMixinBase(dependency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModmacaoPackage.INSTALLATIONDEPENDENCY: {
				Installationdependency installationdependency = (Installationdependency)theEObject;
				T result = caseInstallationdependency(installationdependency);
				if (result == null) result = caseDependency(installationdependency);
				if (result == null) result = caseMixinBase(installationdependency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModmacaoPackage.EXECUTIONDEPENDENCY: {
				Executiondependency executiondependency = (Executiondependency)theEObject;
				T result = caseExecutiondependency(executiondependency);
				if (result == null) result = caseDependency(executiondependency);
				if (result == null) result = caseMixinBase(executiondependency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
