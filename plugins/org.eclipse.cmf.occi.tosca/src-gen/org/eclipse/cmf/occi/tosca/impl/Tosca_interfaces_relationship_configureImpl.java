...
public class Tosca_interfaces_relationship_configureImpl extends Tosca_interfaces_rootImpl implements Tosca_interfaces_relationship_configure {
	...
	protected EClass eStaticClass() {
		return ToscaPackage.Literals.TOSCA_INTERFACES_RELATIONSHIP_CONFIGURE;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ToscaPackage.TOSCA_INTERFACES_RELATIONSHIP_CONFIGURE___PRE_CONFIGURE_SOURCE:
				pre_configure_source();
				return null;
			case ToscaPackage.TOSCA_INTERFACES_RELATIONSHIP_CONFIGURE___PRE_CONFIGURE_TARGET:
				pre_configure_target();
				return null;
			case ToscaPackage.TOSCA_INTERFACES_RELATIONSHIP_CONFIGURE___POST_CONFIGURE_SOURCE:
				post_configure_source();
				return null;
			case ToscaPackage.TOSCA_INTERFACES_RELATIONSHIP_CONFIGURE___POST_CONFIGURE_TARGET:
				post_configure_target();
				return null;
			case ToscaPackage.TOSCA_INTERFACES_RELATIONSHIP_CONFIGURE___REMOVE_TARGET:
				remove_target();
				return null;
			case ToscaPackage.TOSCA_INTERFACES_RELATIONSHIP_CONFIGURE___ADD_TARGET:
				add_target();
				return null;
			case ToscaPackage.TOSCA_INTERFACES_RELATIONSHIP_CONFIGURE___ADD_SOURCE:
				add_source();
				return null;
			case ToscaPackage.TOSCA_INTERFACES_RELATIONSHIP_CONFIGURE___TARGET_CHANGED:
				target_changed();
				return null;
		}
