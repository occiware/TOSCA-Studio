...
public class Tosca_relationships_dependsonImpl extends Tosca_relationships_rootImpl implements Tosca_relationships_dependson {
	...
	protected EClass eStaticClass() {
		return ToscaPackage.Literals.TOSCA_RELATIONSHIPS_DEPENDSON;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ToscaPackage.TOSCA_RELATIONSHIPS_DEPENDSON___SOURCE_MUST_BE_NODE_AND_TARGET_MUST_BE_NODE__DIAGNOSTICCHAIN_MAP:
