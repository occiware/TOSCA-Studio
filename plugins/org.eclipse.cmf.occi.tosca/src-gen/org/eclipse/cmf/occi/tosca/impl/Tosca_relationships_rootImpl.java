 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.tosca.impl.Tosca_relationships_rootImpl#getToscaName <em>Tosca Name</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.tosca.impl.Tosca_relationships_rootImpl#getState <em>State</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.tosca.impl.Tosca_relationships_rootImpl#getToscaId <em>Tosca Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tosca_relationships_rootImpl extends MixinBaseImpl implements Tosca_relationships_root {
	...
	protected EClass eStaticClass() {
		return ToscaPackage.Literals.TOSCA_RELATIONSHIPS_ROOT;
	}
	...
	public void setToscaName(String newToscaName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToscaPackage.TOSCA_RELATIONSHIPS_ROOT__TOSCA_NAME, oldToscaName, toscaName));
	}
	...
	public void setState(String newState) {
		...
		state = newState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToscaPackage.TOSCA_RELATIONSHIPS_ROOT__STATE, oldState, state));
	}
	...
	public void setToscaId(String newToscaId) {
		...
		toscaId = newToscaId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToscaPackage.TOSCA_RELATIONSHIPS_ROOT__TOSCA_ID, oldToscaId, toscaId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ToscaPackage.TOSCA_RELATIONSHIPS_ROOT__TOSCA_NAME:
				return getToscaName();
			case ToscaPackage.TOSCA_RELATIONSHIPS_ROOT__STATE:
				return getState();
			case ToscaPackage.TOSCA_RELATIONSHIPS_ROOT__TOSCA_ID:
				return getToscaId();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ToscaPackage.TOSCA_RELATIONSHIPS_ROOT___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
