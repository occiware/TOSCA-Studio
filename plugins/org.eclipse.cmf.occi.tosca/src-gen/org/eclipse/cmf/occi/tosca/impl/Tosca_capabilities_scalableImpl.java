 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.tosca.impl.Tosca_capabilities_scalableImpl#getMinInstances <em>Min Instances</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.tosca.impl.Tosca_capabilities_scalableImpl#getMaxInstances <em>Max Instances</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.tosca.impl.Tosca_capabilities_scalableImpl#getDefaultInstances <em>Default Instances</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tosca_capabilities_scalableImpl extends Tosca_capabilities_rootImpl implements Tosca_capabilities_scalable {
	...
	protected EClass eStaticClass() {
		return ToscaPackage.Literals.TOSCA_CAPABILITIES_SCALABLE;
	}
	...
	public void setMinInstances(Integer newMinInstances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToscaPackage.TOSCA_CAPABILITIES_SCALABLE__MIN_INSTANCES, oldMinInstances, minInstances));
	}
	...
	public void setMaxInstances(Integer newMaxInstances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToscaPackage.TOSCA_CAPABILITIES_SCALABLE__MAX_INSTANCES, oldMaxInstances, maxInstances));
	}
	...
	public void setDefaultInstances(Integer newDefaultInstances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToscaPackage.TOSCA_CAPABILITIES_SCALABLE__DEFAULT_INSTANCES, oldDefaultInstances, defaultInstances));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ToscaPackage.TOSCA_CAPABILITIES_SCALABLE__MIN_INSTANCES:
				return getMinInstances();
			case ToscaPackage.TOSCA_CAPABILITIES_SCALABLE__MAX_INSTANCES:
				return getMaxInstances();
			case ToscaPackage.TOSCA_CAPABILITIES_SCALABLE__DEFAULT_INSTANCES:
