...
public class Tosca_nodes_rootImpl extends Tosca_capabilities_nodeImpl implements Tosca_nodes_root {
	...
	protected EClass eStaticClass() {
		return ToscaPackage.Literals.TOSCA_NODES_ROOT;
	}
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, ToscaTables.STR_Tosca_nodes_root_c_c_appliesConstraint);
