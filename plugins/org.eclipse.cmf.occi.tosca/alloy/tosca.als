// Generated at Mon Jan 01 19:26:26 CET 2018 from  by org.eclipse.cmf.occi.core.gen.alloy

// ======================================================================
//
// Static Semantics for OCCI Extension 'tosca'
//
// ======================================================================
...
one sig tosca_capabilities_root extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_capabilities_root
}
...
one sig tosca_capabilities_node extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_capabilities_node
}
...
one sig tosca_capabilities_endpoint extends Mixin {} {
    ...
    no actions
    entities in Tosca_capabilities_endpoint
}
...
one sig tosca_capabilities_scalable extends Mixin {} {
    ...
    no actions
    entities in Tosca_capabilities_scalable
}
...
one sig tosca_capabilities_network_bindable extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_capabilities_network_bindable
}
...
one sig tosca_capabilities_container extends Mixin {} {
    ...
    no actions
    entities in Tosca_capabilities_container
}
...
one sig tosca_capabilities_endpoint_database extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_capabilities_endpoint_database
}
...
one sig tosca_capabilities_endpoint_public extends Mixin {} {
    ...
    no actions
    entities in Tosca_capabilities_endpoint_public
}
...
one sig tosca_capabilities_endpoint_admin extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_capabilities_endpoint_admin
}
...
one sig tosca_capabilities_operatingsystem extends Mixin {} {
    ...
    no actions
    entities in Tosca_capabilities_operatingsystem
}
...
one sig tosca_capabilities_attachment extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_capabilities_attachment
}
...
one sig tosca_nodes_webapplication extends Mixin {} {
    ...
    no actions
    entities in Tosca_nodes_webapplication
}
...
one sig tosca_nodes_objectstorage extends Mixin {} {
    ...
    no actions
    entities in Tosca_nodes_objectstorage
}
...
one sig tosca_nodes_compute extends Mixin {} {
    ...
    no actions
    entities in Tosca_nodes_compute
}
...
one sig tosca_nodes_loadbalancer extends Mixin {} {
    ...
    no actions
    entities in Tosca_nodes_loadbalancer
}
...
one sig tosca_nodes_webserver extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_nodes_webserver
}
...
one sig tosca_nodes_database extends Mixin {} {
    ...
    no actions
    entities in Tosca_nodes_database
}
...
one sig tosca_nodes_container_application extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_nodes_container_application
}
...
one sig tosca_nodes_container_runtime extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_nodes_container_runtime
}
...
one sig tosca_nodes_blockstorage extends Mixin {} {
    ...
    no actions
    entities in Tosca_nodes_blockstorage
}
...
one sig tosca_policies_root extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_policies_root
}
...
one sig tosca_policies_update extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_policies_update
}
...
one sig tosca_policies_placement extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_policies_placement
}
...
one sig tosca_policies_scaling extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_policies_scaling
}
...
one sig tosca_policies_performance extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_policies_performance
}
...
one sig tosca_interfaces_root extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_interfaces_root
}
...
one sig tosca_interfaces_relationship_configure extends Mixin {} {
    ...
    entities in Tosca_interfaces_relationship_configure
}
...
one sig tosca_interfaces_node_lifecycle_standard extends Mixin {} {
    ...
    entities in Tosca_interfaces_node_lifecycle_standard
}
...
one sig tosca_relationships_root extends Mixin {} {
    ...
    no actions
    entities in Tosca_relationships_root
}
...
one sig tosca_relationships_connectsto extends Mixin {} {
    ...
    no actions
    entities in Tosca_relationships_connectsto
}
...
one sig tosca_relationships_routesto extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_relationships_routesto
}
...
one sig tosca_relationships_attachesto extends Mixin {} {
    ...
    no actions
    entities in Tosca_relationships_attachesto
}
...
one sig tosca_relationships_hostedon extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_relationships_hostedon
}
...
one sig tosca_relationships_dependson extends Mixin {} {
    ...
    no attributes
    no actions
    entities in Tosca_relationships_dependson
}
