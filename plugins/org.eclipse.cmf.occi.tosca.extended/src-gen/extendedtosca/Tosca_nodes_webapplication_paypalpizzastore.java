...
public interface Tosca_nodes_webapplication_paypalpizzastore extends Tosca_nodes_webapplication, MixinBase {
	 ...
	 * The default value is <code>"https://github.com/sample.git"</code>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @model default="https://github.com/sample.git" dataType="extendedtosca.string"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='throw new UnsupportedOperationException();  // FIXME Unimplemented http://org.occi/tosca/ecore!Tosca_nodes_webapplication_paypalpizzastore!githubUrl'"
	 * @generated
	 */
	String getGithubUrl();
