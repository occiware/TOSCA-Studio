...
public class ExtendedtoscaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExtendedtoscaPackage.TOSCA_NODES_ROOT: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_root);
				if (result == null) result = caseTosca_capabilities_root(tosca_nodes_root);
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_root);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_WEBAPPLICATION: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_webapplication);
				if (result == null) result = caseTosca_capabilities_root(tosca_nodes_webapplication);
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_webapplication);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_softwarecomponent);
				if (result == null) result = caseTosca_capabilities_root(tosca_nodes_softwarecomponent);
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_softwarecomponent);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_DBMS: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_dbms);
				if (result == null) result = caseTosca_capabilities_root(tosca_nodes_dbms);
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_dbms);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_OBJECTSTORAGE: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_objectstorage);
				if (result == null) result = caseTosca_capabilities_root(tosca_nodes_objectstorage);
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_objectstorage);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_COMPUTE: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_compute);
				...
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_compute);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_LOADBALANCER: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_loadbalancer);
				...
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_loadbalancer);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_WEBSERVER: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_webserver);
				if (result == null) result = caseTosca_capabilities_root(tosca_nodes_webserver);
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_webserver);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_DATABASE: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_database);
				...
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_database);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_APPLICATION: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_container_application);
				if (result == null) result = caseTosca_capabilities_root(tosca_nodes_container_application);
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_container_application);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_container_runtime);
				if (result == null) result = caseTosca_capabilities_root(tosca_nodes_container_runtime);
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_container_runtime);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_BLOCKSTORAGE: {
				...
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_blockstorage);
				if (result == null) result = caseTosca_capabilities_root(tosca_nodes_blockstorage);
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_blockstorage);
			...
			case ExtendedtoscaPackage.TOSCA_NODES_WEBAPPLICATION_WORDPRESS: {
				Tosca_nodes_webapplication_wordpress tosca_nodes_webapplication_wordpress = (Tosca_nodes_webapplication_wordpress)theEObject;
				T result = caseTosca_nodes_webapplication_wordpress(tosca_nodes_webapplication_wordpress);
				if (result == null) result = caseTosca_nodes_webapplication(tosca_nodes_webapplication_wordpress);
				if (result == null) result = caseTosca_nodes_root(tosca_nodes_webapplication_wordpress);
				if (result == null) result = caseTosca_capabilities_endpoint(tosca_nodes_webapplication_wordpress);
				if (result == null) result = caseTosca_capabilities_node(tosca_nodes_webapplication_wordpress);
				if (result == null) result = caseTosca_interfaces_node_lifecycle_standard(tosca_nodes_webapplication_wordpress);
				if (result == null) result = caseTosca_capabilities_root(tosca_nodes_webapplication_wordpress);
				if (result == null) result = caseTosca_interfaces_root(tosca_nodes_webapplication_wordpress);
				if (result == null) result = caseMixinBase(tosca_nodes_webapplication_wordpress);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ExtendedtoscaPackage.TOSCA_NODES_WEBSERVER_NODEJS: {
				Tosca_nodes_webserver_nodejs tosca_nodes_webserver_nodejs = (Tosca_nodes_webserver_nodejs)theEObject;
				T result = caseTosca_nodes_webserver_nodejs(tosca_nodes_webserver_nodejs);
				if (result == null) result = caseTosca_nodes_webserver(tosca_nodes_webserver_nodejs);
				if (result == null) result = caseTosca_nodes_softwarecomponent(tosca_nodes_webserver_nodejs);
				if (result == null) result = caseTosca_capabilities_endpoint_admin(tosca_nodes_webserver_nodejs);
				if (result == null) result = caseTosca_capabilities_container(tosca_nodes_webserver_nodejs);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tosca nodes webapplication wordpress</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tosca nodes webapplication wordpress</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTosca_nodes_webapplication_wordpress(Tosca_nodes_webapplication_wordpress object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tosca nodes webserver nodejs</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tosca nodes webserver nodejs</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTosca_nodes_webserver_nodejs(Tosca_nodes_webserver_nodejs object) {
		return null;
	}
