...
public interface Tosca_capabilities_somecap extends Tosca_capabilities_container, MixinBase {
	 ...
	 * @model default="someval" dataType="extendedtosca.string" required="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='throw new UnsupportedOperationException();  // FIXME Unimplemented http://org.occi/tosca/ecore!Tosca_capabilities_somecap!type'"
	 * @generated
	 */
	String getType();
