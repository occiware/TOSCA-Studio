...
public class Tosca_interfaces_node_lifecycle_standardImpl extends Tosca_interfaces_rootImpl implements Tosca_interfaces_node_lifecycle_standard {
	...
	protected EClass eStaticClass() {
		return ExtendedtoscaPackage.Literals.TOSCA_INTERFACES_NODE_LIFECYCLE_STANDARD;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExtendedtoscaPackage.TOSCA_INTERFACES_NODE_LIFECYCLE_STANDARD___CREATE:
				create();
				return null;
			case ExtendedtoscaPackage.TOSCA_INTERFACES_NODE_LIFECYCLE_STANDARD___CONFIGURE:
				configure();
				return null;
			case ExtendedtoscaPackage.TOSCA_INTERFACES_NODE_LIFECYCLE_STANDARD___DELETE:
				delete();
				return null;
		}
