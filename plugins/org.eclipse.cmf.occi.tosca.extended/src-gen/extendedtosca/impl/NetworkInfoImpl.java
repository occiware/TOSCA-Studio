 ...
 * </p>
 * <ul>
 *   <li>{@link extendedtosca.impl.NetworkInfoImpl#getNetworkid <em>Networkid</em>}</li>
 *   <li>{@link extendedtosca.impl.NetworkInfoImpl#getAddresses <em>Addresses</em>}</li>
 *   <li>{@link extendedtosca.impl.NetworkInfoImpl#getNetworkname <em>Networkname</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkInfoImpl extends EObjectImpl implements NetworkInfo {
	...
	protected EClass eStaticClass() {
		return ExtendedtoscaPackage.Literals.NETWORK_INFO;
	}
	...
	public void setNetworkid(String newNetworkid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.NETWORK_INFO__NETWORKID, oldNetworkid, networkid));
	}
	...
	public NotificationChain basicSetAddresses(arraystring newAddresses, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.NETWORK_INFO__ADDRESSES, oldAddresses, newAddresses);
	...
	public void setAddresses(arraystring newAddresses) {
		if (newAddresses != addresses) {
			...
			if (addresses != null)
				msgs = ((InternalEObject)addresses).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExtendedtoscaPackage.NETWORK_INFO__ADDRESSES, null, msgs);
			if (newAddresses != null)
				msgs = ((InternalEObject)newAddresses).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExtendedtoscaPackage.NETWORK_INFO__ADDRESSES, null, msgs);
			msgs = basicSetAddresses(newAddresses, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.NETWORK_INFO__ADDRESSES, newAddresses, newAddresses));
	}
	...
	public void setNetworkname(String newNetworkname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.NETWORK_INFO__NETWORKNAME, oldNetworkname, networkname));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ExtendedtoscaPackage.NETWORK_INFO__ADDRESSES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtendedtoscaPackage.NETWORK_INFO__NETWORKID:
				return getNetworkid();
			case ExtendedtoscaPackage.NETWORK_INFO__ADDRESSES:
				return getAddresses();
			case ExtendedtoscaPackage.NETWORK_INFO__NETWORKNAME:
