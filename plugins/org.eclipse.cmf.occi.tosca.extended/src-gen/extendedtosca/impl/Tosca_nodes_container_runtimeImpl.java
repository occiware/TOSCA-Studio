 ...
 * </p>
 * <ul>
 *   <li>{@link extendedtosca.impl.Tosca_nodes_container_runtimeImpl#getMinInstances <em>Min Instances</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_nodes_container_runtimeImpl#getMaxInstances <em>Max Instances</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_nodes_container_runtimeImpl#getDefaultInstances <em>Default Instances</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_nodes_container_runtimeImpl#getDiskSize <em>Disk Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tosca_nodes_container_runtimeImpl extends Tosca_nodes_softwarecomponentImpl implements Tosca_nodes_container_runtime {
	...
	protected EClass eStaticClass() {
		return ExtendedtoscaPackage.Literals.TOSCA_NODES_CONTAINER_RUNTIME;
	}
	...
	public void setMinInstances(Integer newMinInstances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__MIN_INSTANCES, oldMinInstances, minInstances));
	}
	...
	public void setMaxInstances(Integer newMaxInstances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__MAX_INSTANCES, oldMaxInstances, maxInstances));
	}
	...
	public void setDefaultInstances(Integer newDefaultInstances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__DEFAULT_INSTANCES, oldDefaultInstances, defaultInstances));
	}
	...
	public void setDiskSize(Integer newDiskSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__DISK_SIZE, oldDiskSize, diskSize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__MIN_INSTANCES:
				return getMinInstances();
			case ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__MAX_INSTANCES:
				return getMaxInstances();
			case ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__DEFAULT_INSTANCES:
				return getDefaultInstances();
			case ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__DISK_SIZE:
				return getDiskSize();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Tosca_capabilities_scalable.class) {
			switch (derivedFeatureID) {
				case ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__MIN_INSTANCES: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_SCALABLE__MIN_INSTANCES;
				case ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__MAX_INSTANCES: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_SCALABLE__MAX_INSTANCES;
				case ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__DEFAULT_INSTANCES: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_SCALABLE__DEFAULT_INSTANCES;
				default: return -1;
			}
		}
		if (baseClass == Tosca_capabilities_container.class) {
			switch (derivedFeatureID) {
				case ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__DISK_SIZE: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_CONTAINER__DISK_SIZE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Tosca_capabilities_scalable.class) {
			switch (baseFeatureID) {
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_SCALABLE__MIN_INSTANCES: return ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__MIN_INSTANCES;
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_SCALABLE__MAX_INSTANCES: return ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__MAX_INSTANCES;
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_SCALABLE__DEFAULT_INSTANCES: return ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__DEFAULT_INSTANCES;
				default: return -1;
			}
		}
		if (baseClass == Tosca_capabilities_container.class) {
			switch (baseFeatureID) {
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_CONTAINER__DISK_SIZE: return ExtendedtoscaPackage.TOSCA_NODES_CONTAINER_RUNTIME__DISK_SIZE;
				default: return -1;
			}
		}
