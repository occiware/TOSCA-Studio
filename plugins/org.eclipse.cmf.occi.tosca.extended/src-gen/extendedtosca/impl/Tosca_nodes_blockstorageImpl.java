 ...
 * </p>
 * <ul>
 *   <li>{@link extendedtosca.impl.Tosca_nodes_blockstorageImpl#getSize <em>Size</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_nodes_blockstorageImpl#getVolumeId <em>Volume Id</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_nodes_blockstorageImpl#getSnapshotId <em>Snapshot Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tosca_nodes_blockstorageImpl extends Tosca_nodes_rootImpl implements Tosca_nodes_blockstorage {
	...
	protected EClass eStaticClass() {
		return ExtendedtoscaPackage.Literals.TOSCA_NODES_BLOCKSTORAGE;
	}
	...
	public void setSize(Integer newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_NODES_BLOCKSTORAGE__SIZE, oldSize, size));
	}
	...
	public void setVolumeId(String newVolumeId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_NODES_BLOCKSTORAGE__VOLUME_ID, oldVolumeId, volumeId));
	}
	...
	public void setSnapshotId(String newSnapshotId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_NODES_BLOCKSTORAGE__SNAPSHOT_ID, oldSnapshotId, snapshotId));
	}
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, ExtendedtoscaTables.STR_Tosca_nodes_blockstorage_c_c_appliesConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_infrastructure_c_c_Storage_0 = idResolver.getClass(ExtendedtoscaTables.CLSSid_Storage, null);
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, ExtendedtoscaTables.STR_Tosca_nodes_blockstorage_c_c_appliesConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, ExtendedtoscaTables.INT_0).booleanValue();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtendedtoscaPackage.TOSCA_NODES_BLOCKSTORAGE__SIZE:
				return getSize();
			case ExtendedtoscaPackage.TOSCA_NODES_BLOCKSTORAGE__VOLUME_ID:
				return getVolumeId();
			case ExtendedtoscaPackage.TOSCA_NODES_BLOCKSTORAGE__SNAPSHOT_ID:
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Tosca_nodes_root.class) {
			switch (baseOperationID) {
				case ExtendedtoscaPackage.TOSCA_NODES_ROOT___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP: return ExtendedtoscaPackage.TOSCA_NODES_BLOCKSTORAGE___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExtendedtoscaPackage.TOSCA_NODES_BLOCKSTORAGE___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
