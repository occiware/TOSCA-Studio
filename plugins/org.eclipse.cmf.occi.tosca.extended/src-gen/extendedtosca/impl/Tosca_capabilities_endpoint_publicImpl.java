 ...
 * </p>
 * <ul>
 *   <li>{@link extendedtosca.impl.Tosca_capabilities_endpoint_publicImpl#getFloating <em>Floating</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_capabilities_endpoint_publicImpl#getDnsName <em>Dns Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tosca_capabilities_endpoint_publicImpl extends Tosca_capabilities_endpointImpl implements Tosca_capabilities_endpoint_public {
	...
	protected EClass eStaticClass() {
		return ExtendedtoscaPackage.Literals.TOSCA_CAPABILITIES_ENDPOINT_PUBLIC;
	}
	...
	public void setFloating(Boolean newFloating) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT_PUBLIC__FLOATING, oldFloating, floating));
	}
	...
	public void setDnsName(String newDnsName) {
		...
		dnsName = newDnsName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT_PUBLIC__DNS_NAME, oldDnsName, dnsName));
	}
