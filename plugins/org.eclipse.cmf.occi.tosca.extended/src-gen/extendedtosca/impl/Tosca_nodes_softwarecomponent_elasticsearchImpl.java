	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Tosca_capabilities_endpoint.class) {
			switch (derivedFeatureID) {
				case ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__PORT_NAME: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORT_NAME;
				case ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__PROTOCOL: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PROTOCOL;
				case ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__PORT: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORT;
				case ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__INITIATOR: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__INITIATOR;
				case ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__NETWORK_NAME: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__NETWORK_NAME;
				case ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__SECURE: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__SECURE;
				case ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__PORTS: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORTS;
				case ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__URL_PATH: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__URL_PATH;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Tosca_capabilities_endpoint.class) {
			switch (baseFeatureID) {
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORT_NAME: return ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__PORT_NAME;
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PROTOCOL: return ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__PROTOCOL;
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORT: return ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__PORT;
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__INITIATOR: return ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__INITIATOR;
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__NETWORK_NAME: return ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__NETWORK_NAME;
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__SECURE: return ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__SECURE;
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORTS: return ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__PORTS;
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__URL_PATH: return ExtendedtoscaPackage.TOSCA_NODES_SOFTWARECOMPONENT_ELASTICSEARCH__URL_PATH;
				default: return -1;
			}
		}
