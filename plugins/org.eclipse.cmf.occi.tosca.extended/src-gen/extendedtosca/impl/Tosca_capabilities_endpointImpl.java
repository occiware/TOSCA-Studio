 ...
 * </p>
 * <ul>
 *   <li>{@link extendedtosca.impl.Tosca_capabilities_endpointImpl#getPortName <em>Port Name</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_capabilities_endpointImpl#getProtocol <em>Protocol</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_capabilities_endpointImpl#getPort <em>Port</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_capabilities_endpointImpl#getInitiator <em>Initiator</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_capabilities_endpointImpl#getNetworkName <em>Network Name</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_capabilities_endpointImpl#getSecure <em>Secure</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_capabilities_endpointImpl#getPorts <em>Ports</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_capabilities_endpointImpl#getUrlPath <em>Url Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tosca_capabilities_endpointImpl extends Tosca_capabilities_rootImpl implements Tosca_capabilities_endpoint {
	...
	protected EClass eStaticClass() {
		return ExtendedtoscaPackage.Literals.TOSCA_CAPABILITIES_ENDPOINT;
	}
	...
	public void setPortName(String newPortName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORT_NAME, oldPortName, portName));
	}
	...
	public void setProtocol(String newProtocol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PROTOCOL, oldProtocol, protocol));
	}
	...
	public void setPort(Short newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORT, oldPort, port));
	}
	...
	public void setInitiator(initiatorEnum newInitiator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__INITIATOR, oldInitiator, initiator));
	}
	...
	public void setNetworkName(String newNetworkName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__NETWORK_NAME, oldNetworkName, networkName));
	}
	...
	public void setSecure(Boolean newSecure) {
		...
		secure = newSecure;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__SECURE, oldSecure, secure));
	}
	...
	public void setPorts(Map newPorts) {
		...
		ports = newPorts;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORTS, oldPorts, ports));
	}
	...
	public void setUrlPath(String newUrlPath) {
		...
		urlPath = newUrlPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__URL_PATH, oldUrlPath, urlPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORT_NAME:
				return getPortName();
			case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PROTOCOL:
				return getProtocol();
			case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORT:
				return getPort();
			case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__INITIATOR:
				return getInitiator();
			case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__NETWORK_NAME:
				return getNetworkName();
			case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__SECURE:
				return getSecure();
			case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__PORTS:
				return getPorts();
			case ExtendedtoscaPackage.TOSCA_CAPABILITIES_ENDPOINT__URL_PATH:
				return getUrlPath();
		}
