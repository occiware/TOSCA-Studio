	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Tosca_capabilities_container.class) {
			switch (derivedFeatureID) {
				case ExtendedtoscaPackage.TOSCA_NODES_NODEWITHCAP__DISK_SIZE: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_CONTAINER__DISK_SIZE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Tosca_capabilities_container.class) {
			switch (baseFeatureID) {
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_CONTAINER__DISK_SIZE: return ExtendedtoscaPackage.TOSCA_NODES_NODEWITHCAP__DISK_SIZE;
				default: return -1;
			}
		}
		if (baseClass == Tosca_capabilities_somecap.class) {
