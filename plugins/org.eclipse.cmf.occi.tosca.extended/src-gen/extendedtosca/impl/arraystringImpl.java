 ...
 * </p>
 * <ul>
 *   <li>{@link extendedtosca.impl.arraystringImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class arraystringImpl extends EObjectImpl implements arraystring {
	...
	protected EClass eStaticClass() {
		return ExtendedtoscaPackage.Literals.ARRAYSTRING;
	}
	...
	public EList<String> getValues() {
		if (values == null) {
			values = new EDataTypeEList<String>(String.class, this, ExtendedtoscaPackage.ARRAYSTRING__VALUES);
		}
		return values;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtendedtoscaPackage.ARRAYSTRING__VALUES:
				return getValues();
		}
