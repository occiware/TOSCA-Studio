 ...
 * </p>
 * <ul>
 *   <li>{@link extendedtosca.impl.Tosca_capabilities_containerImpl#getDiskSize <em>Disk Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tosca_capabilities_containerImpl extends Tosca_capabilities_rootImpl implements Tosca_capabilities_container {
	...
	protected EClass eStaticClass() {
		return ExtendedtoscaPackage.Literals.TOSCA_CAPABILITIES_CONTAINER;
	}
	...
	public void setDiskSize(Integer newDiskSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_CAPABILITIES_CONTAINER__DISK_SIZE, oldDiskSize, diskSize));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtendedtoscaPackage.TOSCA_CAPABILITIES_CONTAINER__DISK_SIZE:
				return getDiskSize();
		}
