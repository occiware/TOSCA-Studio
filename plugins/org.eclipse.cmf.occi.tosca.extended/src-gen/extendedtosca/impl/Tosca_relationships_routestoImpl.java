...
public class Tosca_relationships_routestoImpl extends Tosca_relationships_connectstoImpl implements Tosca_relationships_routesto {
	...
	protected EClass eStaticClass() {
		return ExtendedtoscaPackage.Literals.TOSCA_RELATIONSHIPS_ROUTESTO;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExtendedtoscaPackage.TOSCA_RELATIONSHIPS_ROUTESTO___SOURCE_MUST_BE_LOAD_BALANCER__DIAGNOSTICCHAIN_MAP:
