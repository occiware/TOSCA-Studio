 ...
 * </p>
 * <ul>
 *   <li>{@link extendedtosca.impl.Tosca_nodes_dbmsImpl#getDiskSize <em>Disk Size</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_nodes_dbmsImpl#getPort <em>Port</em>}</li>
 *   <li>{@link extendedtosca.impl.Tosca_nodes_dbmsImpl#getRootPassword <em>Root Password</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tosca_nodes_dbmsImpl extends Tosca_nodes_softwarecomponentImpl implements Tosca_nodes_dbms {
	...
	protected EClass eStaticClass() {
		return ExtendedtoscaPackage.Literals.TOSCA_NODES_DBMS;
	}
	...
	public void setDiskSize(Integer newDiskSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_NODES_DBMS__DISK_SIZE, oldDiskSize, diskSize));
	}
	...
	public void setPort(Integer newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_NODES_DBMS__PORT, oldPort, port));
	}
	...
	public void setRootPassword(String newRootPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_NODES_DBMS__ROOT_PASSWORD, oldRootPassword, rootPassword));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtendedtoscaPackage.TOSCA_NODES_DBMS__DISK_SIZE:
				return getDiskSize();
			case ExtendedtoscaPackage.TOSCA_NODES_DBMS__PORT:
				return getPort();
			case ExtendedtoscaPackage.TOSCA_NODES_DBMS__ROOT_PASSWORD:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Tosca_capabilities_container.class) {
			switch (derivedFeatureID) {
				case ExtendedtoscaPackage.TOSCA_NODES_DBMS__DISK_SIZE: return ExtendedtoscaPackage.TOSCA_CAPABILITIES_CONTAINER__DISK_SIZE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Tosca_capabilities_container.class) {
			switch (baseFeatureID) {
				case ExtendedtoscaPackage.TOSCA_CAPABILITIES_CONTAINER__DISK_SIZE: return ExtendedtoscaPackage.TOSCA_NODES_DBMS__DISK_SIZE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExtendedtoscaPackage.TOSCA_NODES_DBMS___SOURCE_MUST_BE_DATABASE__DIAGNOSTICCHAIN_MAP:
