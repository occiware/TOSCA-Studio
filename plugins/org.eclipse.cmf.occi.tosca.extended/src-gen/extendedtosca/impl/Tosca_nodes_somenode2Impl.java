...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tosca nodes somenode2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link extendedtosca.impl.Tosca_nodes_somenode2Impl#getDiskSize <em>Disk Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tosca_nodes_somenode2Impl extends Tosca_nodes_rootImpl implements Tosca_nodes_somenode2 {
	/**
	 ...
	 * @generated
	 */
	protected Tosca_nodes_somenode2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ExtendedtoscaPackage.Literals.TOSCA_NODES_SOMENODE2;
	}
	...
	public void setDiskSize(Integer newDiskSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtendedtoscaPackage.TOSCA_NODES_SOMENODE2__DISK_SIZE, oldDiskSize, diskSize));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Tosca_capabilities_container.class) {
			switch (derivedFeatureID) {
				case ExtendedtoscaPackage.TOSCA_NODES_SOMENODE2__DISK_SIZE: return ToscaPackage.TOSCA_CAPABILITIES_CONTAINER__DISK_SIZE;
				default: return -1;
			}
		}
		if (baseClass == Tosca_capabilities_containerchild.class) {
			switch (derivedFeatureID) {
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Tosca_capabilities_container.class) {
			switch (baseFeatureID) {
				case ToscaPackage.TOSCA_CAPABILITIES_CONTAINER__DISK_SIZE: return ExtendedtoscaPackage.TOSCA_NODES_SOMENODE2__DISK_SIZE;
				default: return -1;
			}
		}
		if (baseClass == Tosca_capabilities_containerchild.class) {
