 ...
 * </p>
 * <ul>
 *   <li>{@link extendedtosca.Tosca_relationships_connectsto#getCredential <em>Credential</em>}</li>
 * </ul>
 *
 * @see extendedtosca.ExtendedtoscaPackage#getTosca_relationships_connectsto()
 * @model
 * @generated
 */
public interface Tosca_relationships_connectsto extends Tosca_relationships_root, MixinBase {
	 ...
	 * @see extendedtosca.ExtendedtoscaPackage#getTosca_relationships_connectsto_Credential()
	...
	/**
	 * Sets the value of the '{@link extendedtosca.Tosca_relationships_connectsto#getCredential <em>Credential</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
