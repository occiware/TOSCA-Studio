...
public interface Tosca_nodes_webserver_nodejs extends Tosca_nodes_webserver, MixinBase {
	 ...
	 * @model default="https://github.com/mmm/testnode.git" dataType="extendedtosca.string"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='throw new UnsupportedOperationException();  // FIXME Unimplemented http://org.occi/tosca/ecore!Tosca_nodes_webserver_nodejs!githubUrl'"
	 * @generated
	 */
	String getGithubUrl();
