 ...
 * </p>
 * <ul>
 *   <li>{@link extendedtosca.Tosca_nodes_dbms#getPort <em>Port</em>}</li>
 *   <li>{@link extendedtosca.Tosca_nodes_dbms#getRootPassword <em>Root Password</em>}</li>
 * </ul>
 *
 * @see extendedtosca.ExtendedtoscaPackage#getTosca_nodes_dbms()
...
public interface Tosca_nodes_dbms extends Tosca_nodes_softwarecomponent, Tosca_capabilities_container, MixinBase {
	 ...
	 * @see #setPort(Integer)
	 * @see extendedtosca.ExtendedtoscaPackage#getTosca_nodes_dbms_Port()
	 * @model dataType="extendedtosca.integer"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='throw new UnsupportedOperationException();  // FIXME Unimplemented http://org.occi/tosca/ecore!Tosca_nodes_dbms!port'"
	 * @generated
	 */
	Integer getPort();

	/**
	 * Sets the value of the '{@link extendedtosca.Tosca_nodes_dbms#getPort <em>Port</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see extendedtosca.ExtendedtoscaPackage#getTosca_nodes_dbms_RootPassword()
	 * @model dataType="extendedtosca.string"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='throw new UnsupportedOperationException();  // FIXME Unimplemented http://org.occi/tosca/ecore!Tosca_nodes_dbms!rootPassword'"
	 * @generated
	 */
	String getRootPassword();

	/**
	 * Sets the value of the '{@link extendedtosca.Tosca_nodes_dbms#getRootPassword <em>Root Password</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
